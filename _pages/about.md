...
My current work focuses on three areas. First, I am developing **SPLAT**, a novel single-cell copy number variant (CNV) calling method for tagmentation-based scDNA-seq that resolves subclonal architecture at high resolution. Second, I apply **multi-region sequencing and spatial transcriptomics** to reconstruct tumor phylogenies and map immune microenvironment heterogeneity — with active projects in intrahepatic cholangiocarcinoma (iCCA), oral cancer, clear cell renal carcinoma (ccRCC), non small cell lung cancer (NSCLC) etc.

Before my PhD, I completed an MPH at UTHealth, BDS at Manipal University (India), and worked as a Research Data Coordinator in the Department of Surgical Oncology at MD Anderson, where I curated the Medullary Thyroid Carcinoma Registry.
